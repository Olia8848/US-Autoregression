...
im = 'C:/Users/olga/Desktop/US_forest/plots_raw_data_BArea/'    
fig = plt.figure()
pyplot.plot(x, Sigmas)
pyplot.show()
fig.savefig(im + 'eco_'+ str(eid) + '_BArea_a_vs_stand_error.png')
...
fig = qq(1, logvalue, lognext, interval, NCHANGES)
